...
axe1.set(xlim = (10, 350), ylim=(5e-1, 1e4), xscale = "log", yscale = "log",
             xlabel = r"$R$ (AU)", ylabel = r"$\Sigma$ (kg/m²)")
axe1.set_xticks([10, 50, 100, 150, 200, 300])
...
axe2.set(xlim = (10, 350), ylim = (1e-9, 1e-1), xscale = "log", yscale = "log",
             xlabel = r"$R$ (AU)", ylabel = r"$P$ (Pa)")
axe2.set_xticks([10, 50, 100, 150, 200, 300])
...
axe3.set(xlim = (10, 350), ylim = (5e-3, 0.5),xscale = "log", yscale = "log",
             xlabel = r"$R$ (AU)", ylabel = r"$Dustfrac$")
axe3.set_xticks([10, 50, 100, 150, 200, 300])
