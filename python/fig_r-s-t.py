...
for radius in radius0:
    ...
    line = axes.scatter(r, s, c = t, s = 0.5, norm = colors.LogNorm(1, 1e8), cmap = "rainbow")
...
# Axes and labels
axes.set(xlim = (10, 310), ylim = (5e-8, 5e6), xscale = "log", yscale = "log",
...
plt.savefig(path2 + "fig_" + mass_or_size + "_r-s-t.png")

print("fig_" + mass_or_size + "_r-s-t.png done")
